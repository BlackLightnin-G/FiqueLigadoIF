...
public class Atividade {
    ...
    public Atividade(Integer id, String titulo, LocalDateTime dataHoraInicio,
            LocalDateTime dataHoraFim, Double cargaHoraria, Integer quantidadeVagas,
    ...
    public String toString() {
        return "Atividade [id=" + id + ", titulo=" + titulo + ", dataHoraInicio=" + dataHoraInicio
                ...
                + ", quantidadeVagas=" + quantidadeVagas + ", evento=" + evento
                + ", local=" + local + "]";
    }
}
